    ...
    <div class="py-12">
        <div class="max-w-7x1 mx-auto sm:px-6 lg:px-8">
            <div class="my-6 p-6 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                <form action="{{ route('doctors.update', $doctor) }}" method="post" enctype="multipart/formdata">   <!-- displaying inputs for user, routing to the controller functions, the old values are displayed -->
                @method('put')
                @csrf
                <x-text-input
                    type="text"
