    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="my-6 p-6 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                <form action="{{ route('doctors.store') }}" method="post" enctype="multipart/form-data">  <!-- routing to controller functions, calling old data and displaying inputs for user -->
                    @csrf
                    <x-text-input
                        type="text"
                        name="first_name"
